...
- Usar CharacterBody2D para el jugador (El movimiento se basa en script), usar Area2D (Cuando quiera crear objetos que detecten otros objetos) y usar Sprite2D para agregarles un Sprite al objeto.
- Agregar música a un juego mediante AudioStreamPlayer2D
- Introducción al UID, cree un HUB que muestre el Score del jugador
...
- Agregar poderes para el jugador, con spawn aleatorio en el visor
